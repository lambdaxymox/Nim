...
F.line = 8;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples1.nim(8, 8) `jsregex in r\"abc\"` "));
}

if (!(!(contains_536870961("abcd", jsregex_520093698)))) {
F.line = 9;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples1.nim(9, 8) `jsregex notin r\"abcd\"` "));
}

if (!(contains_536870961("xabc", jsregex_520093698))) {
F.line = 10;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples1.nim(10, 8) `\"xabc\".contains jsregex` "));
}
...
F.line = 8;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples2.nim(8, 8) `\"abcd\".startsWith jsregex` "));
}
...
F.line = 8;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples3.nim(8, 8) `\"abcd\".endsWith jsregex` "));
}
...
function HEX2EHEX2E_587202594(a_587202597, b_587202598) {
  ...
  framePtr = F;
    F.line = 507;
    result_587202601 = nimCopy(result_587202601, {a: a_587202597, b: b_587202598}, NTI587202595);
  framePtr = F.prev;
...
function HEX3DHEX3D_587202572(x_587202574, y_587202575) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__587202698 = nimCopy(colontmp__587202698, HEX2EHEX2E_587202594(0, subInt((x_587202574).length, 1)), NTI587202595);
      Label2: do {
        F.line = 129;
        var x_587202704 = 0;
        F.line = 90;
...
F.line = 9;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(9, 8) `\"nim javascript\".contains jsregex` "));
}

if (!(HEX3DHEX3D_587202572(jsregex_587202562.exec("nim javascript"), ["nim"]))) {
F.line = 10;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(10, 8) `jsregex.exec(r\"nim javascript\") == @[\"nim\".cstring]` "));
}

if (!((jsregex_587202562.toString() == "/\\w+/i"))) {
F.line = 11;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(11, 8) `jsregex.toCstring() == r\"/\\w+/i\"` "));
}
...
F.line = 13;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(13, 8) `\"0123456789abcd\".contains jsregex` "));
}

if (!(eqStrings(HEX24_536870953(jsregex_587202562), makeNimstrLit("/[0-9]/i")))) {
F.line = 14;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(14, 8) `$jsregex == \"/[0-9]/i\"` "));
}
...
F.line = 16;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(16, 8) `\"abcd\".startsWith jsregex` "));
}

if (!(endsWith_536870978("dabc", jsregex_587202562))) {
F.line = 17;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(17, 8) `\"dabc\".endsWith jsregex` "));
}
...
F.line = 19;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(19, 8) `\"do1ne\".split(jsregex) == @[\"do\".cstring, \"ne\".cstring]` "));
}
...
F.line = 21;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples4.nim(21, 8) `\"hello world\".replace(jsregex, \"X\") == \"heXlo world\"` "));
}
