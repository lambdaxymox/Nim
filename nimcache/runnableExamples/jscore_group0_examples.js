...
function HEX2EHEX2E_520093731(a_520093734, b_520093735) {
  ...
  framePtr = F;
    F.line = 507;
    result_520093738 = nimCopy(result_520093738, {a: a_520093734, b: b_520093735}, NTI520093739);
  framePtr = F.prev;
...
function HEX3DHEX3D_520093709(x_520093711, y_520093712) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__520093947 = nimCopy(colontmp__520093947, HEX2EHEX2E_520093731(0, subInt((x_520093711).length, 1)), NTI520093739);
      Label2: do {
        F.line = 129;
        var x_520093953 = 0;
        F.line = 90;
...
function HEX3DHEX3D_520093799(x_520093801, y_520093802) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__520093966 = nimCopy(colontmp__520093966, HEX2EHEX2E_520093731(0, subInt((x_520093801).length, 1)), NTI520093739);
      Label2: do {
        F.line = 129;
        var x_520093968 = 0;
        F.line = 90;
...
F.line = 7;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(7, 8) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(0, 3, 4) == @[\'d\', \'b\', \'c\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_520093709([97, 98, 99, 100, 101].copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 8;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(8, 8) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(1, 3) == @[\'a\', \'d\', \'e\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_520093799(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2), [1, 2, 3, 1, 2]))) {
F.line = 9;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(9, 8) `[1, 2, 3, 4, 5].copyWithin(-2) == @[1, 2, 3, 1, 2]` "));
}

if (!(HEX3DHEX3D_520093799(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 10;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(10, 8) `[1, 2, 3, 4, 5].copyWithin(0, 3) == @[4, 5, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_520093799(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 11;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(11, 8) `[1, 2, 3, 4, 5].copyWithin(0, 3, 4) == @[4, 2, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_520093799(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2, -3, -1), [1, 2, 3, 3, 4]))) {
F.line = 12;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(12, 8) `[1, 2, 3, 4, 5].copyWithin(-2, -3, -1) == @[1, 2, 3, 3, 4]` "));
}
